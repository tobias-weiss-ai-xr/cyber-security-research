...
**Generated:** 42 concepts, 269 relationships from 17119 papers. Edges = co-occurrence (shared papers).

## Top concepts

| Concept | Kind | Papers |
|----------|------|--------|
| framework | curated | 2602 |
| Network Security | taxonomy | 1283 |
| Incident Response | taxonomy | 1202 |
| Vulnerability Management | taxonomy | 1122 |
| Cryptography | taxonomy | 1111 |
| Malware Analysis | taxonomy | 980 |
| Ai Security | taxonomy | 970 |
| Application Security | taxonomy | 963 |
| Identity Access | taxonomy | 956 |
| Supply Chain Security | taxonomy | 937 |
| Cloud Security | taxonomy | 910 |
| Zero Trust | taxonomy | 829 |
| Threat Intelligence | taxonomy | 786 |
| Privacy | taxonomy | 738 |
...
| benchmark | curated | 384 |
| case study | curated | 241 |
| literature review | curated | 213 |
| taxonomy | curated | 172 |
| systematic review | curated | 165 |
| quantitative | curated | 147 |
| qualitative | curated | 102 |
| reproducibility | curated | 67 |
| experiment | curated | 59 |
| peer review | curated | 14 |
| interview | curated | 12 |
| mixed methods | curated | 6 |
| research gap | curated | 6 |
| open access | curated | 5 |
| grounded theory | curated | 2 |
| meta analysis | curated | 1 |
| triangulation | curated | 1 |

## Relationships (top concepts → related concepts)

### framework

- Network Security — 271 shared paper(s)
- dataset — 228 shared paper(s)
- Cryptography — 192 shared paper(s)
- Vulnerability Management — 182 shared paper(s)
- Ai Security — 180 shared paper(s)
- Security Compliance — 167 shared paper(s)
- Zero Trust — 166 shared paper(s)
- benchmark — 152 shared paper(s)

### Network Security

- framework — 271 shared paper(s)
- dataset — 176 shared paper(s)
...
- framework — 136 shared paper(s)
- dataset — 92 shared paper(s)
...
- literature review — 19 shared paper(s)
- taxonomy — 10 shared paper(s)
- case study — 10 shared paper(s)
...
- systematic review — 15 shared paper(s)
...
- Network Security — 176 shared paper(s)
- benchmark — 108 shared paper(s)
- Malware Analysis — 92 shared paper(s)
- Vulnerability Management — 90 shared paper(s)
- Supply Chain Security — 50 shared paper(s)
- Ai Security — 45 shared paper(s)
- Application Security — 38 shared paper(s)
...
- Ai Security — 58 shared paper(s)
- Network Security — 49 shared paper(s)
- Application Security — 48 shared paper(s)
- Cryptography — 41 shared paper(s)
- Iot Security — 35 shared paper(s)
- taxonomy — 34 shared paper(s)
- Zero Trust — 29 shared paper(s)
- Identity Access — 27 shared paper(s)

### Human Factor

- framework — 43 shared paper(s)
- dataset — 36 shared paper(s)
- taxonomy — 19 shared paper(s)
- survey — 15 shared paper(s)
...
- framework — 152 shared paper(s)
- dataset — 108 shared paper(s)
- Network Security — 88 shared paper(s)
- Ai Security — 58 shared paper(s)
- Vulnerability Management — 50 shared paper(s)
- Application Security — 40 shared paper(s)
- Malware Analysis — 19 shared paper(s)
- Cloud Security — 17 shared paper(s)

### case study

- framework — 52 shared paper(s)
- Risk Management — 24 shared paper(s)
- Vulnerability Management — 22 shared paper(s)
- Incident Response — 20 shared paper(s)
- Security Compliance — 17 shared paper(s)
- Security Education — 15 shared paper(s)
- dataset — 14 shared paper(s)
- Supply Chain Security — 14 shared paper(s)
